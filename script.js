...
if(event.keyCode === 13) todoButon.click();
...
const removeTodo = (target) => {
    ...
    target.parentNode.classList.add('animate__animated','animate__slideOutRight','animate__faster');
...
const makeItDone = (target) => {
    ...
    target.parentNode.childNodes[2].setAttribute('onclick',
    'removeDone(this)');
    target.className='';
